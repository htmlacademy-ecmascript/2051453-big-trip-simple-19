...
function getPicturesMock() {
  return ({
    ...
    description: getRandomElement(PICTURES_DISCRIPTION_MOCK)
  });
}
...
{
  id: 9,
  description: 'Lloret de Mar is a Mediterranean coastal town in Catalonia, Italy.',
  name: 'infero',
  pictures: Array.from({length: getRandomNumber(10)}, getPicturesMock),
},
{
